...
>
> **Snapshot of the cross-campaign facts ledger as of Ep 5 played (2026-08-29) + Ep 6 planning.** Canonical version lives at `design/DM-ONLY/facts-ledger.md`; this snapshot exists for the DM's binder and print bundle.
>
> **New since the Ep 4 snapshot:** §37 (PC home neighbourhoods + the Fisherman's Wharf prank) and §38 (Ep 5 played — the pinned date spine, Farallon Mutual Casualty, Alaia's ledger recognition, Rosa's Saturday, Bea's colour-coded index, the party holding photographs rather than Ortiz's page, Mira's notebook read at the 10–11 band, Nia's undated lunch).
>
> **Also new and NOT in this file:** `design/DM-ONLY/dakota-phase-gates.md` — {{pc:4}}'s realization gate is undefined and open at high priority. Read it before writing any beat that touches his casting.
>
> **Source uses `{{pc:N}}` template variables (per public-repo hygiene). The PDF-render step substitutes real character names.**
>
