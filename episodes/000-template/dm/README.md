...
>
> This folder holds the DM-only material for the *Template Episode*. Files here describe twists, hidden NPCs, encounter design, and anything else the players are not meant to read ahead of time.
>
...
- [twists.md](twists.md) — DM-only notes for the template scene.
