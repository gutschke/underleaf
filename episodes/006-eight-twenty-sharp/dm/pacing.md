...
**Target 2h30 · ceiling 3h.** Honestly counted this runs **3h10**. **Two cuts are already applied; a third is on a gate.**

## Gates

| T+ | | T+ | |
|---|---|---|---|
| **0:40** | **OUT of the house — hard** | 2:10 | back at the kitchen |
| 0:50 | into the hall | **2:35** | the ledger + what she used to be |
| 1:05 | dance begins | **2:50** | done |

**Blow the 0:40 gate and the hall gets eaten.** Set a visible timer. Everything that makes this session unlike the last two is inside that room.
...
| 4 · **The dance — 5 rounds** | 55 | 35 | **a round, once begun** |
...
2. **Dance: four rounds, then three** — fire {{pc:2}}'s moment in round three (−22)
...
- **One sentence per reach**, cut off mid-word: *"— and she's gone."* **Round one onward.**
