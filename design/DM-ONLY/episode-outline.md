...
## Act I open (Eps 1-4) — played canon (historical, for context)

**These entries are retrospective.** Eps 1-4 all played (Ep 4 on 2026-08-22). They are included in the outline so the arc's full session-level flow is visible in one place. For load-bearing detail per episode, see the linked `dm/` docs. "Risk if slips" is not shown (past-tense) — replaced by *"Load-bearing detail"* pointing at where the played record + DM-held answers live.
...
- **This is also where A5 lands — and the object is her planner, not a wall calendar.** Fixing the PA is what puts him at the table where Rosa left her bag. **See THE PLANNER below**; the wall calendar is retired *as A5's vehicle* but stays in the hall as {{pc:1}}'s articulation refusal — see the articulation pass. *(An A5 fact was briefly homed on the hall's sign-in binder as well — that binder now belongs to {{pc:3}}'s green cards, and {{pc:1}} does not need it.)*
...
- **Rosa never generalises her own stopping.** Per §44 she chose, decades ago, for a person, and it went from there. She may show it; she must not say *"this is how it goes for everyone."* **The weight belongs to B21, her Ep 18 second session.**
...
- **Fires:** A9 · A8 (Yui check-in) · ~~T1 (Reggie)~~ · T2 · T4 (Ren + Maya, 3 min) · ~~B15 re-plant~~ **(moved 2026-09-24 to the Bea coda that opens Ep 9, inside its own Eps 8–10 re-plant window)** — Bea's *unrequested* envelope with the Marsh galaxies-sentient clipping. **U9's letter went back to Ep 6** (2026-08-30) when A4 moved in here; this envelope carries the clipping only.
...
> [!IMPORTANT]
> **Bao's lecture is no longer its own session.** It moves into **Ep 15's keynote day** — see below. The pairing is thematically stronger than the standalone was: *the academic explains the shape in the morning while the industry demonstrates it in the afternoon.* Both are the party-as-anonymous-audience register, and running them on one day costs one venue instead of two.
>
> **This slot is now the campaign's floating buffer.** Do not author content into it. When a session overruns — and on this table's record roughly one in three will — the schedule absorbs it here instead of pushing the ending out.

**Re-homed out of the old Ep 13:**

- **B1 retires → Ep 12** (it was already at near-completion there; the evidence floor lands in the same session).
...
> - **Ep 21** has been absorbed outright — it is now a buffer slot, not a session.
>
...
>
> **Name an S1 instance explicitly in each of Eps 9, 10, 11, 12 and 14** (Ep 13 is a buffer slot). Candidates already in play: Ep 10 an estate lawyer's assistant over-agreeing with a wrong routing; Ep 11 **Ortiz mentioning, unprompted, that the reclassification request did not come from her supervisor — it came from the system, on a schedule**; Ep 14 the faction conversation stalling because a passenger agrees too readily with something specific and wrong. *(Bao's Q&A instance moved to Ep 15 with the lecture.)* **This is the highest-leverage single fix in this file.**
...
| Ep 18 | **3** | Rosa's second session *(moved from Ep 12, 2026-09-06)* — she is the one who finally makes the excised diagram mean something (also closes B21). |
